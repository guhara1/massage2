...
if (existsSync("out/index.html")) {
  ...
  home = home.replace(/<section class="section" id="map"><h2>서비스 지도<\/h2><div class="grid-3">[\s\S]*?<\/div><\/section>/, mapSection);
